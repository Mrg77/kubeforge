...
const EN: Record<string, string> = {
  ...
  'heat.restarting': 'restarting a lot',
  'heat.unhealthy': 'unhealthy',
  'heat.hint': 'hover a cell for details · click to open its events',
  'topo.nodes': '{n} nodes',
  'topo.node': '{n} node',
  'topo.pods': '{n} pods',
  ...
  // AI chat
  'chat.title': 'Ask your cluster',
  'chat.clear': 'clear',
  'chat.intro': 'Ask anything about this cluster — grounded in the live scans (health, security, cost) and pod events. Not sure where to start?',
  'chat.privacy': 'KubeForge sends findings and resource names — never raw objects or secrets. Your key stays local.',
  'chat.placeholder': 'Ask about your cluster…',
  'chat.thinking': 'thinking…',
  'chat.notConfigured': 'No AI configured yet',
  'chat.notConfiguredSub': 'Add a provider and key (Gemini and Groq are free) to chat with your cluster.',
  'chat.setup': 'Set it up',
  'chat.q.summary': 'What are the top things to fix right now?',
  'chat.q.waste': 'Where am I wasting the most money?',
  'chat.q.unhealthy': 'Why are my unhealthy pods failing?',
  'chat.q.arch': 'Any weak points in my cluster setup?',
  // AI panel
  'ai.title': 'AI analysis',
  'ai.ready': 'ready',
  'ai.notConfigured': 'not configured',
  'ai.settings': 'settings',
  'ai.openChat': 'Open the cluster chat',
  ...
  'ai.free': 'free',
  'ai.freeBanner': "No need to pay — Gemini and Groq give you a free API key (no card). A chat subscription (Claude Max, ChatGPT Plus) does NOT include API access.",
  'ai.errCredit': "This provider's API needs its own credit — a chat subscription (Claude Max, ChatGPT Plus) doesn't fund it. Either add a few $ of API credit, or pick a free provider above (Gemini / Groq).",
  'ai.errKey': 'That API key looks invalid. Check you copied the whole key (and use an API key, not a login password).',
  'ai.model': 'Model',
  'ai.apiKey': 'API key',
  'ai.getKey': 'get a key →',
  'ai.loadModels': 'load my models →',
  'ai.loadingModels': 'loading…',
  'ai.modelsLoaded': '{n} models found',
  'ai.modelHint': 'default list — enter your key and click "load my models" for your real, current models.',
...
const FR: Record<string, string> = {
  ...
  'topo.lens.heatmap': 'Heatmap',
  'heat.healthy': 'en bonne santé',
  'heat.restarting': 'redémarre souvent',
  'heat.unhealthy': 'en panne',
  'heat.hint': 'survolez une cellule pour le détail · cliquez pour ses events',
  'topo.nodes': '{n} nodes',
  'topo.node': '{n} node',
  'topo.pods': '{n} pods',
  ...
  'chat.title': 'Demandez à votre cluster',
  'chat.clear': 'effacer',
  'chat.intro': 'Posez n\'importe quelle question sur ce cluster — ancrée dans les scans en direct (santé, sécurité, coût) et les events des pods. Pas sûr par où commencer ?',
  'chat.privacy': 'KubeForge envoie les findings et les noms de ressources — jamais d\'objets bruts ni de secrets. Votre clé reste locale.',
  'chat.placeholder': 'Posez une question sur votre cluster…',
  'chat.thinking': 'réflexion…',
  'chat.notConfigured': 'Aucune IA configurée',
  'chat.notConfiguredSub': 'Ajoutez un fournisseur et une clé (Gemini et Groq sont gratuits) pour discuter avec votre cluster.',
  'chat.setup': 'Configurer',
  'chat.q.summary': 'Quelles sont les priorités à corriger maintenant ?',
  'chat.q.waste': 'Où est-ce que je gaspille le plus d\'argent ?',
  'chat.q.unhealthy': 'Pourquoi mes pods en panne échouent-ils ?',
  'chat.q.arch': 'Y a-t-il des points faibles dans mon architecture ?',
  'ai.title': 'Analyse IA',
  'ai.ready': 'prête',
  'ai.notConfigured': 'non configurée',
  'ai.settings': 'réglages',
  'ai.openChat': 'Ouvrir le chat du cluster',
  ...
  'ai.free': 'gratuit',
  'ai.freeBanner': "Pas besoin de payer — Gemini et Groq donnent une clé API gratuite (sans carte). Un abonnement chat (Claude Max, ChatGPT Plus) N'INCLUT PAS l'accès API.",
  'ai.errCredit': "L'API de ce fournisseur a besoin de son propre crédit — un abonnement chat (Claude Max, ChatGPT Plus) ne le finance pas. Ajoutez quelques $ de crédit API, ou choisissez un fournisseur gratuit ci-dessus (Gemini / Groq).",
  'ai.errKey': 'Cette clé API semble invalide. Vérifiez que vous avez copié la clé entière (et que c\'est bien une clé API, pas un mot de passe de connexion).',
  'ai.model': 'Modèle',
  'ai.apiKey': 'Clé API',
  'ai.getKey': 'obtenir une clé →',
  'ai.loadModels': 'charger mes modèles →',
  'ai.loadingModels': 'chargement…',
  'ai.modelsLoaded': '{n} modèles trouvés',
  'ai.modelHint': 'liste par défaut — saisissez votre clé et cliquez « charger mes modèles » pour vos vrais modèles à jour.',
